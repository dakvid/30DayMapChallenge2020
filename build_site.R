    ...
    div(class = "row",
        div(class = "col-12",
            ...
            p("There is far too much for me to get through in a timely fashion, so",
              "I'm hoping to draw on the wonders of crownsourcing. Speaking of which..."),
            ...
            p("Unlike last year, I had the foresight to create a spearate git repository",
              ...
              "which means that those who are so inclined can clone just the text files",
              "without the 100s of MB of map images. That's the best place for a pull request.",
